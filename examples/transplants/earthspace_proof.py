...
def main() -> int:
    ...
    parser.add_argument("--bundle", type=Path, default=Path("examples/transplants/earthspace_bundle.json"))
    parser.add_argument("--sentinel", type=Path, default=Path("examples/transplants/earthspace_sentinel.json"))
