...
def main() -> int:
    ...
    parser.add_argument("--bundle", type=Path, default=Path("examples/proteomics/proteomics_bundle.json"))
    parser.add_argument("--sentinel", type=Path, default=Path("examples/proteomics/proteomics_sentinel.json"))
