"""Earth/Space transplant adapter built on CEREVIA's universal contracts.

The low-level Earth-rotation helpers under ``third_party/coresignal_earth``
are an extracted, licensed internal foundation from the CoreSignal project;
they are not a runtime dependency or an independent trust layer.
"""
